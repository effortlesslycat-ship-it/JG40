...
'xDb_Conn_Str = "dsn=RegionsSolr;uid=goldmine;pwd=p1mpl3"

xDb_Conn_Str = "Driver={MySQL ODBC 8.0 Unicode Driver};" & _
	"Server=jewishgen13;" & _
	"Database=jewishgen;" & _
	"Uid=mtobias;" & _
	"Pwd=nt732b#$;"
...
Set rstGetRows = conn.Execute("SELECT * FROM regionssolr ORDER by rorder")
...
strPath = Server.MapPath ("/databases/Regions/RegionsData_solr.js")
