<?php
/* ============================================================================
   /databases/Bulgaria/index.php  -  JewishGen Bulgaria Database
...
$jg_collection = array(
    ...
    'title'      => 'JewishGen Bulgaria Database',
    'lede'       => 'Records for the Jewish community of Bulgaria, from a variety of sources.',
    'stat'       => '',
    'card_title' => 'Search the Bulgaria Collection',
    'button'     => 'Search the Bulgaria Database',
    'intro'      => ''
);
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>JewishGen Bulgaria Database</title>
    <meta name="keywords" content="Bulgaria">
    <meta name="description" content="Search JewishGen's Bulgaria records, and browse every database in the collection.">
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/databases/searchform.php'; ?>
    ...
    <div class="catalog-list db-compact" id="collectionList" aria-label="Bulgaria database listing"></div>
