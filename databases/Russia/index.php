<?php
/* ============================================================================
   /databases/Russia/index.php  -  JewishGen Russia Database
...
$jg_collection = array(
    ...
    'title'      => 'JewishGen Russia Database',
    'lede'       => 'Records for the area now known as Russia, the Russian Empire, and the Soviet Union.',
    'stat'       => 'Over 74,000 entries.',
    'card_title' => 'Search the Russia Collection',
    'button'     => 'Search the Russia Database',
    'intro'      => '<p>Welcome to the JewishGen Russia Database. This is a multiple database search facility which incorporates all the databases listed below. These databases have been contributed by individual donors. The combined databases have over 74,000 entries, referring to individuals living in the area now known as Russia, the Russian Empire, and the Soviet Union. The database is a work in progress and new entries are being added regularly.</p>'
);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>JewishGen Russia Database</title>
    <meta name="keywords" content="Russia, Russian Empire, Soviet Union">
    <meta name="description" content="Search JewishGen's Russia records, and browse every database in the collection.">
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/databases/searchform.php'; ?>
    ...
    <div class="catalog-list db-compact" id="collectionList" aria-label="Russia database listing"></div>
