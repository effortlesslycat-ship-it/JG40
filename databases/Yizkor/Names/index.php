<?php
/**
 * yizkor-names-index.php  -  The JewishGen Yizkor Book Master Name Index search form
 *
 ...
 *   3. Region list is the YBMNI tree from RegionsData_solr.js.
 *
...
<head>
    ...
    <title>The JewishGen Yizkor Book Master Name Index &mdash; JewishGen</title>
    <meta name="description" content="Search the JewishGen Yizkor Book Master Name Index: names indexed from the full text of Yizkor Books.">
...
<main id="main-content">
    ...
    <div class="page-title-band">
        <div class="page-title-band__inner">
            ...
            <h1>The JewishGen Yizkor Book Master Name Index</h1>
            <p class="hero-subtitle">Search names indexed from the full text of Yizkor Books &mdash; beyond the necrologies.</p>
            <span class="stat-line">More than 90,000 entries indexed from 132 Yizkor Books.</span>
        </div>
    </div>
        ...
        <div class="mem-search-wrap">
            ...
            <div class="jg-search-card">
                ...
                <div class="jg-search-card__header">
                    <h2>Search the Master Name Index</h2>
                    <button type="button"
                            class="jg-tips-link"
                            aria-expanded="false"
                ...
                <form action="/search-results.php" method="post" aria-label="Yizkor Book master name index search">
                    ...
                    <div class="mem-controls">
                        ...
                        <div class="mem-geo-group">
                            ...
                            <!-- Values are full Solr region codes (YBMNI tree,
                                 RegionsData_solr.js). "All Regions" is empty so the
                                 hidden allcountry=01ybmni applies as fallback. -->
                            <select id="GeoRegion" name="GeoRegion" aria-label="Region to search">
                                <option value="">All Regions</option>
                                <option value="01ybmni_00austria">Austria</option>
                                <optgroup label="Belarus">
                                    <option value="01ybmni_00belarus">All Belarus</option>
                                    <option value="01ybmni_00belarus_01grodno">&nbsp;&nbsp;&nbsp;Grodno Gubernia</option>
                                    <option value="01ybmni_00belarus_02minsk">&nbsp;&nbsp;&nbsp;Minsk Gubernia</option>
                                    <option value="01ybmni_00belarus_03mogilev">&nbsp;&nbsp;&nbsp;Mogilev Gubernia</option>
                                    <option value="01ybmni_00belarus_04vilna">&nbsp;&nbsp;&nbsp;Vilna Gubernia</option>
                                    <option value="01ybmni_00belarus_05vitebsk">&nbsp;&nbsp;&nbsp;Vitebsk Gubernia</option>
                                </optgroup>
                                <option value="01ybmni_00croatia">Croatia</option>
                                <optgroup label="Czech Republic">
                                    <option value="01ybmni_00czechrepublic">All Czech Republic</option>
                                    <option value="01ybmni_00czechrepublic_01bohemia">&nbsp;&nbsp;&nbsp;Bohemia</option>
                                </optgroup>
                                <option value="01ybmni_00germany">Germany</option>
                                <option value="01ybmni_00greece">Greece</option>
                                <option value="01ybmni_00hungary">Hungary</option>
                                <optgroup label="Latvia">
                                    <option value="01ybmni_00latvia">All Latvia</option>
                                    <option value="01ybmni_00latvia_01courland">&nbsp;&nbsp;&nbsp;Courland</option>
                                    <option value="01ybmni_00latvia_02livlandriga">&nbsp;&nbsp;&nbsp;Livland</option>
                                    <option value="01ybmni_00latvia_03vitebsk">&nbsp;&nbsp;&nbsp;Vitebsk Gubernia</option>
                                    <option value="01ybmni_00latvia_04estland">&nbsp;&nbsp;&nbsp;Estonia</option>
                                </optgroup>
                                <optgroup label="Lithuania">
                                    <option value="01ybmni_00lithuania">All Lithuania</option>
                                    <option value="01ybmni_00lithuania_01kovno">&nbsp;&nbsp;&nbsp;Kovno Gubernia</option>
                                    <option value="01ybmni_00lithuania_02vilna">&nbsp;&nbsp;&nbsp;Vilna Gubernia</option>
                                    <option value="01ybmni_00lithuania_03suwalki">&nbsp;&nbsp;&nbsp;Suwalki Gubernia</option>
                                </optgroup>
                                <option value="01ybmni_00macedonia">North Macedonia</option>
                                <option value="01ybmni_00moldova">Moldova</option>
                                <option value="01ybmni_00netherlands">Netherlands</option>
                                <optgroup label="Poland">
                                    <option value="01ybmni_00poland">All Poland</option>
                                    <option value="01ybmni_00poland_01pale">&nbsp;&nbsp;&nbsp;Russian Pale</option>
                                    <option value="01ybmni_00poland_01pale_01grodno">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Grodno Gubernia</option>
                                    <option value="01ybmni_00poland_01pale_02vilna">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Vilna Gubernia</option>
                                    <option value="01ybmni_00poland_01pale_03volhynia">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Volhynia Gubernia</option>
                                    <option value="01ybmni_00poland_02congress">&nbsp;&nbsp;&nbsp;Congress Poland</option>
                                    <option value="01ybmni_00poland_02congress_01kalisz">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Kalisz Gubernia</option>
                                    <option value="01ybmni_00poland_02congress_02kielce">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Kielce Gubernia</option>
                                    <option value="01ybmni_00poland_02congress_03lomza">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#321;om&#380;a Gubernia</option>
                                    <option value="01ybmni_00poland_02congress_04lublin">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Lublin Gubernia</option>
                                    <option value="01ybmni_00poland_02congress_05piotrkow">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Piotrk&#243;w Gubernia</option>
                                    <option value="01ybmni_00poland_02congress_06plock">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;P&#322;ock Gubernia</option>
                                    <option value="01ybmni_00poland_02congress_07radom">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Radom Gubernia</option>
                                    <option value="01ybmni_00poland_02congress_08siedlce">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Siedlce Gubernia</option>
                                    <option value="01ybmni_00poland_02congress_09suwalki">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Suwalki Gubernia</option>
                                    <option value="01ybmni_00poland_02congress_10warszawa">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Warszawa Gubernia</option>
                                    <option value="01ybmni_00poland_03galicia">&nbsp;&nbsp;&nbsp;Galicia</option>
                                    <option value="01ybmni_00poland_03galicia_01krakow">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Krak&#243;w Wojew&#243;dztwa</option>
                                    <option value="01ybmni_00poland_03galicia_02lwow">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Lw&#243;w Wojew&#243;dztwa</option>
                                    <option value="01ybmni_00poland_03galicia_03stanislawow">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Stanis&#322;aw&#243;w Wojew&#243;dztwa</option>
                                    <option value="01ybmni_00poland_03galicia_04tarnopol">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tarnopol Wojew&#243;dztwa</option>
                                    <option value="01ybmni_00poland_04prussia">&nbsp;&nbsp;&nbsp;Prussia</option>
                                </optgroup>
                                <optgroup label="Romania">
                                    <option value="01ybmni_00romania">All Romania</option>
                                    <option value="01ybmni_00romania_02bessarabia">&nbsp;&nbsp;&nbsp;Bessarabia Gubernia</option>
                                    <option value="01ybmni_00romania_03bucovina">&nbsp;&nbsp;&nbsp;Bucovina</option>
                                    <option value="01ybmni_00romania_04crisana">&nbsp;&nbsp;&nbsp;Cri&#351;ana</option>
                                    <option value="01ybmni_00romania_06maramures">&nbsp;&nbsp;&nbsp;Maramure&#351;</option>
                                    <option value="01ybmni_00romania_07moldavia">&nbsp;&nbsp;&nbsp;Moldavia</option>
                                    <option value="01ybmni_00romania_10transylvania">&nbsp;&nbsp;&nbsp;Transylvania</option>
                                </optgroup>
                                <option value="01ybmni_00serbia">Serbia</option>
                                <option value="01ybmni_00slovakia">Slovakia</option>
                                <optgroup label="Ukraine">
                                    <option value="01ybmni_00ukraine">All Ukraine</option>
                                    <option value="01ybmni_00ukraine_01russianempire">&nbsp;&nbsp;&nbsp;Russian Empire</option>
                                    <option value="01ybmni_00ukraine_01russianempire_01bessarabia">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bessarabia Gubernia</option>
                                    <option value="01ybmni_00ukraine_01russianempire_02chernigov">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Chernigov Gubernia</option>
                                    <option value="01ybmni_00ukraine_01russianempire_03ekaterinoslav">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ekaterinoslav Gubernia</option>
                                    <option value="01ybmni_00ukraine_01russianempire_04kiev">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Kiev Gubernia</option>
                                    <option value="01ybmni_00ukraine_01russianempire_05kharkov">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Kharkov Gubernia</option>
                                    <option value="01ybmni_00ukraine_01russianempire_06kherson">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Kherson Gubernia</option>
                                    <option value="01ybmni_00ukraine_01russianempire_07podolia">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Podolia Gubernia</option>
                                    <option value="01ybmni_00ukraine_01russianempire_08poltava">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Poltava Gubernia</option>
                                    <option value="01ybmni_00ukraine_01russianempire_09taurida">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Taurida Gubernia</option>
                                    <option value="01ybmni_00ukraine_01russianempire_10volhynia">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Volhynia Gubernia</option>
                                    <option value="01ybmni_00ukraine_02austrianempire">&nbsp;&nbsp;&nbsp;Austrian Empire</option>
                                    <option value="01ybmni_00ukraine_02austrianempire_01galicia">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Galicia</option>
                                    <option value="01ybmni_00ukraine_02austrianempire_01galicia_01lwow">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Lw&#243;w Wojew&#243;dztwa</option>
                                    <option value="01ybmni_00ukraine_02austrianempire_01galicia_02stanislawow">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Stanis&#322;aw&#243;w Wojew&#243;dztwa</option>
                                    <option value="01ybmni_00ukraine_02austrianempire_01galicia_03tarnopol">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tarnopol Wojew&#243;dztwa</option>
                                    <option value="01ybmni_00ukraine_02austrianempire_02bucovina">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bucovina</option>
                                    <option value="01ybmni_00ukraine_02austrianempire_03transcarpathia">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Transcarpathia</option>
                                </optgroup>
                            </select>
                        </div>
                    ...
                    <div class="mem-search-actions">
                        <button type="submit" class="btn-search">Search the Master Name Index</button>
                        <button type="reset" class="jg-btn-reset">Clear</button>
                    </div>
                    <input type="hidden" name="allcountry" value="01ybmni">
                </form>
            </div><!-- /.jg-search-card -->
        </div><!-- /.mem-search-wrap -->
    </div><!-- /.mem-search-band -->
