<?php
/* ============================================================================
   /databases/Turkey/index.php  -  JewishGen Turkey Database
...
$jg_collection = array(
    ...
    'title'      => 'JewishGen Turkey Database',
    'lede'       => 'Records for the Jewish communities of Turkey, from a variety of sources.',
    'stat'       => '',
    'card_title' => 'Search the Turkey Collection',
    'button'     => 'Search the Turkey Database',
    'intro'      => ''
);
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>JewishGen Turkey Database</title>
    <meta name="keywords" content="Turkey">
    <meta name="description" content="Search JewishGen's Turkey records, and browse every database in the collection.">
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/databases/searchform.php'; ?>
    ...
    <div class="catalog-list db-compact" id="collectionList" aria-label="Turkey database listing"></div>
