...
<HTML>
<HEAD>
   <TITLE>JewishGen Balkans Database</TITLE>
...
<!--#include virtual="/databases/Balkans/$Header.txt"-->
...
region = "00Balkans"
button = " Search the JewishGen Balkans Database "
...
<!--#include virtual="/databases/Balkans/$Components.txt"-->
