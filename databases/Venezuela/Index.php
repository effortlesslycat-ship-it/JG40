<?php
/* ============================================================================
   /databases/Venezuela/index.php  -  JewishGen Venezuela Database
...
$jg_collection = array(
    ...
    'title'      => 'JewishGen Venezuela Database',
    'lede'       => 'Records for the Jewish community of Venezuela, from a variety of sources.',
    'stat'       => '',
    'card_title' => 'Search the Venezuela Collection',
    'button'     => 'Search the Venezuela Database',
    'intro'      => ''
);
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>JewishGen Venezuela Database</title>
    <meta name="keywords" content="Venezuela">
    <meta name="description" content="Search JewishGen's Venezuela records, and browse every database in the collection.">
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/databases/searchform.php'; ?>
    ...
    <div class="catalog-list db-compact" id="collectionList" aria-label="Venezuela database listing"></div>
