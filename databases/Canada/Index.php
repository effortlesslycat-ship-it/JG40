<?php
/* ============================================================================
   /databases/Canada/index.php  -  JewishGen Canada Database
...
$jg_collection = array(
    ...
    'title'      => 'JewishGen Canada Database',
    'lede'       => 'Records for individuals living in Canada, from a variety of sources.',
    'stat'       => 'Nearly 250,000 entries for individuals living in Canada.',
    'card_title' => 'Search the Canada Collection',
    'button'     => 'Search the Canada Database',
    'intro'      => '<p>Welcome to the JewishGen Canada Database. This is a multiple database search facility which incorporates all the databases listed below. The combined databases contain nearly 250,000 entries for individuals living in Canada. The database is a work in progress, and new entries are being added regularly.</p>'
);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>JewishGen Canada Database</title>
    <meta name="keywords" content="Canada">
    <meta name="description" content="Search JewishGen's Canada records, and browse every database in the collection.">
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/databases/searchform.php'; ?>
    ...
    <div class="catalog-list db-compact" id="collectionList" aria-label="Canada database listing"></div>
