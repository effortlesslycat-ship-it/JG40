<?php
/* ============================================================================
   /databases/Portugal/index.php  -  JewishGen Portugal Database
...
$jg_collection = array(
    ...
    'title'      => 'JewishGen Portugal Database',
    'lede'       => 'Records for the Jewish community of Portugal, from a variety of sources.',
    'stat'       => '',
    'card_title' => 'Search the Portugal Collection',
    'button'     => 'Search the Portugal Database',
    'intro'      => ''
);
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>JewishGen Portugal Database</title>
    <meta name="keywords" content="Portugal">
    <meta name="description" content="Search JewishGen's Portugal records, and browse every database in the collection.">
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/databases/searchform.php'; ?>
    ...
    <div class="catalog-list db-compact" id="collectionList" aria-label="Portugal database listing"></div>
