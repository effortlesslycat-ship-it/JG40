<?php
/* ============================================================================
   /databases/India/index.php  -  JewishGen India Database
...
$jg_collection = array(
    ...
    'title'      => 'JewishGen India Database',
    'lede'       => 'Records for the Jewish communities of India, from a variety of sources.',
    'stat'       => '',
    'card_title' => 'Search the India Collection',
    'button'     => 'Search the India Database',
    'intro'      => ''
);
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>JewishGen India Database</title>
    <meta name="keywords" content="India">
    <meta name="description" content="Search JewishGen's India records, and browse every database in the collection.">
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/databases/searchform.php'; ?>
    ...
    <div class="catalog-list db-compact" id="collectionList" aria-label="India database listing"></div>
