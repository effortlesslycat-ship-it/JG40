<?php
/* ============================================================================
   /databases/Sephardic/index.php  -  JewishGen Sephardic Database
...
$jg_collection = array(
    'sys'        => 'SEPH',
    'solr'       => '00Sephardic',
    'tagline'    => 'Topical Collection',
    'title'      => 'JewishGen Sephardic Database',
    'lede'       => 'Sephardic genealogy records across Europe, North Africa, the Middle East, and the Americas.',
    'stat'       => 'Nearly 170,000 records spanning close to 500 years.',
    'card_title' => 'Search the Sephardic Collection',
    'button'     => 'Search the Sephardic Database',
    'intro'      => '<p>Welcome to the JewishGen Sephardic Database. This comprehensive search tool provides access to nearly 170,000 Sephardic genealogy records spanning close to 500 years. Covering communities across Europe, North Africa, the Middle East, and the Americas, the database brings together vital records, censuses, and name lists, and continues to expand as additional records are indexed.</p>'
);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>JewishGen Sephardic Database</title>
    <meta name="keywords" content="Sephardic, Ladino, Mizrahi">
    <meta name="description" content="Search JewishGen's Sephardic records, and browse every database in the collection.">
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/databases/searchform.php'; ?>
    ...
    <div class="catalog-list db-compact" id="collectionList" aria-label="Sephardic database listing"></div>
