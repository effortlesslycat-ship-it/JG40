<?php
/* ============================================================================
   /databases/Lithuania/index.php  -  JewishGen Lithuania Collection
...
$jg_collection = array(
    ...
    'title'      => 'JewishGen Lithuania Collection',
    'lede'       => 'A multiple-database search across the JewishGen Lithuania Collection, including the LitvakSIG All Lithuania Database.',
    'stat'       => 'More than 2.4 million records.',
    'card_title' => 'Search the Lithuania Collection',
    'button'     => 'Search the Lithuania Database',
    'intro'      => '<p>The JewishGen Lithuania Collection is a multiple-database search, which incorporates all of the databases listed below. In total, the collection includes more than 2.4 million records.</p>'
);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>JewishGen Lithuania Collection</title>
    <meta name="keywords" content="Lithuania, Kovno, Vilna, Suwalki">
    <meta name="description" content="Search JewishGen's Lithuania records, and browse every database in the collection.">
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/databases/searchform.php'; ?>
    ...
    <div class="catalog-list db-compact" id="collectionList" aria-label="Lithuania database listing"></div>
