<?php
/* ============================================================================
   /databases/AustriaCzech/index.php  -  JewishGen Austria-Czech Database
...
$jg_collection = array(
    ...
    'title'      => 'JewishGen Austria-Czech Database',
    'lede'       => 'Records from the Jewish communities of Austria and the Czech Republic (Bohemia and Moravia) &mdash; vital records, census lists, and more.',
    'stat'       => 'More than 2.7 million records (as of August 2024).',
    'card_title' => 'Search the Austria-Czech Collection',
    'button'     => 'Search the Austria-Czech Database',
    'intro'      => '<p>As of August 2024, it encompasses more than 2.7 million records from Jewish communities which once existed in Austria and the Czech Republic (Bohemia and Moravia), including vital records, census lists and other types of documents. The database is continually updated, with new records being added regularly.</p><p>For more information, or to get involved, please contact <a class="db-textlink" href="mailto:rschoenberg@JewishGen.org">Randy Schoenberg</a>.</p>'
);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <meta name="keywords" content="Austria, Czechia, Bohemia, Moravia, Czech Republic">
    <meta name="description" content="Search JewishGen's Austria and Czech (Bohemia and Moravia) records, and browse every database in the collection.">
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/databases/searchform.php'; ?>
    ...
    <div class="rd-crossover">
        <div class="rd-crossover__inner">
            Researching Austrian or Czech roots? The <a class="db-textlink" href="/RD/AustriaCzech/index.html">Austria-Czech Research Division</a> has town pages, research guides, and community resources. &rarr;
        </div>
    </div>
    ...
    <div class="catalog-list db-compact" id="collectionList" aria-label="Austria-Czech database listing"></div>
