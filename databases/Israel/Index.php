<?php
/* ============================================================================
   /databases/Israel/index.php  -  JewishGen Israel Database
...
$jg_collection = array(
    ...
    'title'      => 'JewishGen Israel Database',
    'lede'       => 'Records for the Land and State of Israel, from a variety of sources.',
    'stat'       => '',
    'card_title' => 'Search the Israel Collection',
    'button'     => 'Search the Israel Database',
    'intro'      => ''
);
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>JewishGen Israel Database</title>
    <meta name="keywords" content="Israel">
    <meta name="description" content="Search JewishGen's Israel records, and browse every database in the collection.">
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/databases/searchform.php'; ?>
    ...
    <div class="catalog-list db-compact" id="collectionList" aria-label="Israel database listing"></div>
