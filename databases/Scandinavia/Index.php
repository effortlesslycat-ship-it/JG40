<?php
/* ============================================================================
   /databases/Scandinavia/index.php  -  JewishGen Scandinavia Database
...
$jg_collection = array(
    ...
    'title'      => 'JewishGen Scandinavia Database',
    'lede'       => 'Records from Denmark, Sweden, Norway, and Finland.',
    'stat'       => 'Over 18,000 entries.',
    'card_title' => 'Search the Scandinavia Collection',
    'button'     => 'Search the Scandinavia Database',
    'intro'      => '<p>The JewishGen Scandinavia Database is a multiple-database search, which incorporates all of the databases listed below. The combined databases contain over 18,000 entries from Denmark, Sweden, Norway, and Finland, contributed by the JewishGen <a class="db-textlink" href="https://jewishgen.org/Scandinavia/">Scandinavia SIG</a> and individual donors. The database is a work in progress and new entries are being added regularly.</p>'
);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>JewishGen Scandinavia Database</title>
    <meta name="keywords" content="Scandinavia, Denmark, Sweden, Norway, Finland">
    <meta name="description" content="Search JewishGen's Scandinavia records, and browse every database in the collection.">
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/databases/searchform.php'; ?>
    ...
    <div class="catalog-list db-compact" id="collectionList" aria-label="Scandinavia database listing"></div>
...
<script>
    jgCollectionInit({
        regionSys:  'ALLSCANDINAVIA',
        regionTag:  'Scandinavia'
    });
</script>
