<?php
/* ============================================================================
   /databases/Argentina/index.php  -  JewishGen Argentina Database
...
$jg_collection = array(
    ...
    'title'      => 'JewishGen Argentina Database',
    'lede'       => 'Records for individuals living in Argentina, from a variety of sources.',
    'stat'       => '',
    'card_title' => 'Search the Argentina Collection',
    'button'     => 'Search the Argentina Database',
    'intro'      => ''
);
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>JewishGen Argentina Database</title>
    <meta name="keywords" content="Argentina">
    <meta name="description" content="Search JewishGen's Argentina records, and browse every database in the collection.">
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/databases/searchform.php'; ?>
    ...
    <div class="catalog-list db-compact" id="collectionList" aria-label="Argentina database listing"></div>
