<?php
/* ============================================================================
   /databases/Greece/index.php  -  JewishGen Greece Database
...
$jg_collection = array(
    ...
    'title'      => 'JewishGen Greece Database',
    'lede'       => 'Records for the Jewish communities of Greece, from a variety of sources.',
    'stat'       => '',
    'card_title' => 'Search the Greece Collection',
    'button'     => 'Search the Greece Database',
    'intro'      => ''
);
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>JewishGen Greece Database</title>
    <meta name="keywords" content="Greece">
    <meta name="description" content="Search JewishGen's Greece records, and browse every database in the collection.">
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/databases/searchform.php'; ?>
    ...
    <div class="catalog-list db-compact" id="collectionList" aria-label="Greece database listing"></div>
