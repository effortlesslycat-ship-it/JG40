<?php
/* ============================================================================
   /databases/Syria/index.php  -  JewishGen Syria Database
...
$jg_collection = array(
    ...
    'title'      => 'JewishGen Syria Database',
    'lede'       => 'Records for the Jewish communities of Syria, from a variety of sources.',
    'stat'       => '',
    'card_title' => 'Search the Syria Collection',
    'button'     => 'Search the Syria Database',
    'intro'      => ''
);
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>JewishGen Syria Database</title>
    <meta name="keywords" content="Syria">
    <meta name="description" content="Search JewishGen's Syria records, and browse every database in the collection.">
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/databases/searchform.php'; ?>
    ...
    <div class="catalog-list db-compact" id="collectionList" aria-label="Syria database listing"></div>
