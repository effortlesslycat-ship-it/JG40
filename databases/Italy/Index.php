<?php
/* ============================================================================
   /databases/Italy/index.php  -  JewishGen Italy Database
...
$jg_collection = array(
    ...
    'title'      => 'JewishGen Italy Database',
    'lede'       => 'Records for the Jewish communities of Italy, from a variety of sources.',
    'stat'       => '',
    'card_title' => 'Search the Italy Collection',
    'button'     => 'Search the Italy Database',
    'intro'      => ''
);
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>JewishGen Italy Database</title>
    <meta name="keywords" content="Italy">
    <meta name="description" content="Search JewishGen's Italy records, and browse every database in the collection.">
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/databases/searchform.php'; ?>
    ...
    <div class="catalog-list db-compact" id="collectionList" aria-label="Italy database listing"></div>
