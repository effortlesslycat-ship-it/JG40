<?php
/* ============================================================================
   /databases/Spain/index.php  -  JewishGen Spain Database
...
$jg_collection = array(
    ...
    'title'      => 'JewishGen Spain Database',
    'lede'       => 'Records for the Jewish communities of Spain, from a variety of sources.',
    'stat'       => '',
    'card_title' => 'Search the Spain Collection',
    'button'     => 'Search the Spain Database',
    'intro'      => ''
);
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>JewishGen Spain Database</title>
    <meta name="keywords" content="Spain">
    <meta name="description" content="Search JewishGen's Spain records, and browse every database in the collection.">
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/databases/searchform.php'; ?>
    ...
    <div class="catalog-list db-compact" id="collectionList" aria-label="Spain database listing"></div>
