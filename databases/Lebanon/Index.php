<?php
/* ============================================================================
   /databases/Lebanon/index.php  -  JewishGen Lebanon Database
...
$jg_collection = array(
    ...
    'title'      => 'JewishGen Lebanon Database',
    'lede'       => 'Records for the Jewish community of Lebanon, from a variety of sources.',
    'stat'       => '',
    'card_title' => 'Search the Lebanon Collection',
    'button'     => 'Search the Lebanon Database',
    'intro'      => ''
);
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>JewishGen Lebanon Database</title>
    <meta name="keywords" content="Lebanon">
    <meta name="description" content="Search JewishGen's Lebanon records, and browse every database in the collection.">
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/databases/searchform.php'; ?>
    ...
    <div class="catalog-list db-compact" id="collectionList" aria-label="Lebanon database listing"></div>
