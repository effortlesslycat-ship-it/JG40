<?php
/* ============================================================================
   /databases/Algeria/index.php  -  JewishGen Algeria Database
...
$jg_collection = array(
    ...
    'title'      => 'JewishGen Algeria Database',
    'lede'       => 'Genealogy records and sources from Algeria &mdash; marriage records, census and tax records, Holocaust records, burial records, and more.',
    'stat'       => 'Over 8,500 records.',
    'card_title' => 'Search the Algeria Collection',
    'button'     => 'Search the Algeria Database',
    'intro'      => '<p>Welcome to the Algeria Database at JewishGen, the genealogical research division of The Museum of Jewish Heritage. This comprehensive search tool provides access to over 8,500 genealogy records and sources from Algeria, including marriage records, census and tax records, Holocaust records, burial records, and more. This database continues to expand as additional records are indexed.</p>'
);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>JewishGen Algeria Database</title>
    <meta name="keywords" content="Algeria">
    <meta name="description" content="Search JewishGen's Algeria records, and browse every database in the collection.">
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/databases/searchform.php'; ?>
    ...
    <div class="catalog-list db-compact" id="collectionList" aria-label="Algeria database listing"></div>
