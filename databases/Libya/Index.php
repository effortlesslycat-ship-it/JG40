<?php
/* ============================================================================
   /databases/Libya/index.php  -  JewishGen Libya Database
...
$jg_collection = array(
    ...
    'title'      => 'JewishGen Libya Database',
    'lede'       => 'Records for the Jewish community of Libya, from a variety of sources.',
    'stat'       => '',
    'card_title' => 'Search the Libya Collection',
    'button'     => 'Search the Libya Database',
    'intro'      => ''
);
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>JewishGen Libya Database</title>
    <meta name="keywords" content="Libya">
    <meta name="description" content="Search JewishGen's Libya records, and browse every database in the collection.">
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/databases/searchform.php'; ?>
    ...
    <div class="catalog-list db-compact" id="collectionList" aria-label="Libya database listing"></div>
