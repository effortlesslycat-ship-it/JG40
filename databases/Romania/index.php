<?php
/* ============================================================================
   /databases/Romania/index.php  -  JewishGen Romania Database
...
$jg_collection = array(
    ...
    'lede'       => 'Search records for Romania, Moldova, and Bessarabia &mdash; vital records, censuses, business directories, Yizkor books, Holocaust sources, and more.',
    'stat'       => 'More than 1.6 million records across the Romania collection.',
...
<head>
    ...
    <title>JewishGen Romania Database</title>
    <meta name="keywords" content="Romania, Romanian, Moldova, Bessarabia">
    <meta name="description" content="Search JewishGen's Romania, Moldova, and Bessarabia records, and browse every database in the collection.">
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/databases/searchform.php'; ?>
    ...
    <div class="rd-crossover">
        <div class="rd-crossover__inner">
            Researching Romanian roots? The <a class="db-textlink" href="/rd/romania/index.html">Romania Research Division</a> has town pages, research guides, and community resources. &rarr;
        </div>
    </div>
    ...
    <div class="catalog-list db-compact" id="collectionList" aria-label="Romania database listing"></div>
