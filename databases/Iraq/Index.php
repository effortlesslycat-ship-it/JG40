<?php
/* ============================================================================
   /databases/Iraq/index.php  -  JewishGen Iraq Database
...
$jg_collection = array(
    ...
    'title'      => 'JewishGen Iraq Database',
    'lede'       => 'Records for the Jewish community of Iraq, from a variety of sources.',
    'stat'       => '',
    'card_title' => 'Search the Iraq Collection',
    'button'     => 'Search the Iraq Database',
    'intro'      => ''
);
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>JewishGen Iraq Database</title>
    <meta name="keywords" content="Iraq">
    <meta name="description" content="Search JewishGen's Iraq records, and browse every database in the collection.">
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/databases/searchform.php'; ?>
    ...
    <div class="catalog-list db-compact" id="collectionList" aria-label="Iraq database listing"></div>
