<?php
/* ============================================================================
   /databases/Belarus/index.php  -  JewishGen Belarus Database
...
$jg_collection = array(
    ...
    'title'      => 'JewishGen Belarus Database',
    'lede'       => 'A multiple-database search across every Belarus collection listed below.',
    'stat'       => 'More than 800,000 entries from Belarus.',
    'card_title' => 'Search the Belarus Collection',
    'button'     => 'Search the Belarus Database',
    'intro'      => '<p>The JewishGen Belarus Database is a multiple-database search, which incorporates all of the databases listed below, containing more than 800,000 entries from Belarus.</p>'
);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <meta name="description" content="Search JewishGen's Belarus records, and browse every database in the collection.">
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/databases/searchform.php'; ?>
    ...
    <div class="rd-crossover">
        <div class="rd-crossover__inner">
            Researching Belarusian roots? The <a class="db-textlink" href="/RD/Belarus/index.html">Belarus Research Division</a> has town pages, research guides, and community resources. &rarr;
        </div>
    </div>
    ...
    <div class="catalog-list db-compact" id="collectionList" aria-label="Belarus database listing"></div>
