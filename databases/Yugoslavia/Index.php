<?php
/* ============================================================================
   /databases/Yugoslavia/index.php  -  JewishGen Former Yugoslavia Database
...
$jg_collection = array(
    ...
    'title'      => 'JewishGen Former Yugoslavia Database',
    'lede'       => 'Records for the Jewish communities of the former Yugoslavia.',
    'stat'       => '',
    'card_title' => 'Search the Former Yugoslavia Collection',
    'button'     => 'Search the Former Yugoslavia Database',
    'intro'      => ''
);
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>JewishGen Former Yugoslavia Database</title>
    <meta name="keywords" content="Yugoslavia, Serbia, Croatia, Bosnia">
    <meta name="description" content="Search JewishGen's Former Yugoslavia records, and browse every database in the collection.">
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/databases/searchform.php'; ?>
    ...
    <div class="catalog-list db-compact" id="collectionList" aria-label="Former Yugoslavia database listing"></div>
...
<script>
    jgCollectionInit({
        regionSys:  'YUGOSLAVIA',
        regionTag:  ['Yugoslavia','Former Yugoslavia']
    });
</script>
