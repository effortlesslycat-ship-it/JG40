<?php
/* ============================================================================
   /databases/Morocco/index.php  -  JewishGen Morocco Database
...
$jg_collection = array(
    ...
    'title'      => 'JewishGen Morocco Database',
    'lede'       => 'Genealogy records and sources from Morocco &mdash; marriage records, community records, burial records, family trees, and more.',
    'stat'       => 'Over 43,700 records.',
    'card_title' => 'Search the Morocco Collection',
    'button'     => 'Search the Morocco Database',
    'intro'      => '<p>Welcome to the Morocco Database at JewishGen, the genealogical research division of The Museum of Jewish Heritage. This comprehensive search tool provides access to over 43,700 genealogy records and sources from Morocco, including marriage records, community records, burial records, family trees, and more. This database continues to expand as additional records are indexed.</p>'
);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>JewishGen Morocco Database</title>
    <meta name="keywords" content="Morocco">
    <meta name="description" content="Search JewishGen's Morocco records, and browse every database in the collection.">
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/databases/searchform.php'; ?>
    ...
    <div class="catalog-list db-compact" id="collectionList" aria-label="Morocco database listing"></div>
